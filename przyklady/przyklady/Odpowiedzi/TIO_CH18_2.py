...
# OdpowiedŸ do zadania praktycznego 2, z rozdzia³u 18.

# Program PyPong, w którym prêdkoœæ i kierunek poruszania siê pi³ki
# zmienia siê w sposób losowy
...
class KlasaMojaPilka(pygame.sprite.Sprite):
    ...
    # sprawdzamy czy w wyniku dobrania losowych wartoœci prêdkoœci
    # pi³ka nie zacznie przesuwaæ siê za szybko    
